...
const ProjectCard = ({ project }) => {
  return (
    <div className="flex-none project_card w-[300px] h-[410px] bg-white border-solid border-2 border-black rounded-2xl">
      ...
      />
      <p className="text-blue-600 font-medium text-base mb-2.5 mx-5 mt-5">#{project.tag}</p>
      <p className="text-zinc-700 font-medium text-base mx-5 leading-5">{project.title}</p>
    </div>
  );
};
